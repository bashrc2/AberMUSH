...
def setPlayerClo_neck(etarget, ebody, players, npcs, items, env, npcsDB, envDB):
        tempVar = 0

def setPlayerClo_lwrist(etarget, ebody, players, npcs, items, env, npcsDB, envDB):
        tempVar = 0

def setPlayerClo_rwrist(etarget, ebody, players, npcs, items, env, npcsDB, envDB):
        tempVar = 0
...
def spawnNPC(etarget, ebody, players, npcs, items, env, npcsDB, envDB):
        ...
        if npcsDB[int(body[0])]['siz']==0:
                npcsDB[int(body[0])]['siz'] = sizeFromDescription(npcsDB[int(body[0])]['name'] + ' ' + npcsDB[int(body[0])]['lookDescription'])

        if not npcExists(npcs,npcsDB[int(body[0])]['name']):
                npcs[getFreeKey(npcs, 90000)] = { 'name': npcsDB[int(body[0])]['name'], 'room': body[1], 'lvl': npcsDB[int(body[0])]['lvl'], 'exp': npcsDB[int(body[0])]['exp'], 'str': npcsDB[int(body[0])]['str'], 'siz': npcsDB[int(body[0])]['siz'], 'wei': npcsDB[int(body[0])]['wei'], 'per': npcsDB[int(body[0])]['per'], 'endu': npcsDB[int(body[0])]['endu'], 'cha': npcsDB[int(body[0])]['cha'], 'int': npcsDB[int(body[0])]['int'], 'agi': npcsDB[int(body[0])]['agi'], 'follow': npcsDB[int(body[0])]['follow'], 'bodyType': npcsDB[int(body[0])]['bodyType'], 'canWear': npcsDB[int(body[0])]['canWear'], 'canWield': npcsDB[int(body[0])]['canWield'], 'luc': npcsDB[int(body[0])]['luc'], 'cool': npcsDB[int(body[0])]['cool'], 'ref': npcsDB[int(body[0])]['ref'], 'cred': npcsDB[int(body[0])]['cred'], 'inv': npcsDB[int(body[0])]['inv'], 'speakLanguage': npcsDB[int(body[0])]['speakLanguage'], 'language': npcsDB[int(body[0])]['language'], 'conv': npcsDB[int(body[0])]['conv'], 'path': npcsDB[int(body[0])]['path'], 'moveDelay': npcsDB[int(body[0])]['moveDelay'], 'moveType': npcsDB[int(body[0])]['moveType'], 'isAttackable': int(body[2]), 'isStealable': int(body[3]), 'isKillable': int(body[4]), 'isAggressive': int(body[5]), 'clo_head': npcsDB[int(body[0])]['clo_head'], 'clo_neck': npcsDB[int(body[0])]['clo_neck'], 'clo_lwrist': npcsDB[int(body[0])]['clo_lwrist'], 'clo_rwrist': npcsDB[int(body[0])]['clo_rwrist'], 'clo_larm': npcsDB[int(body[0])]['clo_larm'], 'clo_rarm': npcsDB[int(body[0])]['clo_rarm'], 'clo_lhand': npcsDB[int(body[0])]['clo_lhand'], 'clo_rhand': npcsDB[int(body[0])]['clo_rhand'], 'clo_chest': npcsDB[int(body[0])]['clo_chest'], 'clo_lleg': npcsDB[int(body[0])]['clo_lleg'], 'clo_rleg': npcsDB[int(body[0])]['clo_rleg'], 'clo_feet': npcsDB[int(body[0])]['clo_feet'], 'imp_head': npcsDB[int(body[0])]['imp_head'], 'imp_larm': npcsDB[int(body[0])]['imp_larm'], 'imp_rarm': npcsDB[int(body[0])]['imp_rarm'], 'imp_lhand': npcsDB[int(body[0])]['imp_lhand'], 'imp_rhand': npcsDB[int(body[0])]['imp_rhand'], 'imp_chest': npcsDB[int(body[0])]['imp_chest'], 'imp_lleg': npcsDB[int(body[0])]['imp_lleg'], 'imp_rleg': npcsDB[int(body[0])]['imp_rleg'], 'imp_feet': npcsDB[int(body[0])]['imp_feet'], 'hp': npcsDB[int(body[0])]['hp'],'hpMax': npcsDB[int(body[0])]['hpMax'], 'charge': npcsDB[int(body[0])]['charge'], 'corpseTTL': int(body[6]), 'respawn': int(body[7]), 'vocabulary': npcsDB[int(body[0])]['vocabulary'], 'talkDelay': npcsDB[int(body[0])]['talkDelay'], 'inDescription': npcsDB[int(body[0])]['inDescription'], 'outDescription': npcsDB[int(body[0])]['outDescription'], 'lookDescription': npcsDB[int(body[0])]['lookDescription'], 'timeTalked': 0, 'isInCombat': 0, 'lastCombatAction': 0, 'lastRoom': None, 'whenDied': None, 'randomizer': 0, 'randomFactor': npcsDB[int(body[0])]['randomFactor'], 'lastSaid': 0, 'lastMoved': 0, 'race': npcsDB[int(body[0])]['race'], 'characterClass': npcsDB[int(body[0])]['characterClass'], 'proficiencies': npcsDB[int(body[0])]['proficiencies'], 'fightingStyle': npcsDB[int(body[0])]['fightingStyle'], 'restRequired': npcsDB[int(body[0])]['restRequired'], 'enemy': npcsDB[int(body[0])]['enemy'], 'archetype': npcsDB[int(body[0])]['archetype'], 'preparedSpells': npcsDB[int(body[0])]['preparedSpells'], 'spellSlots': npcsDB[int(body[0])]['spellSlots'], 'tempHitPoints': npcsDB[int(body[0])]['tempHitPoints'], 'tempHitPointsStart': npcsDB[int(body[0])]['tempHitPointsStart'], 'tempHitPointsDuration': npcsDB[int(body[0])]['tempHitPointsDuration'], 'frozenDuration': npcsDB[int(body[0])]['frozenDuration'], 'frozenStart': npcsDB[int(body[0])]['frozenStart'], 'frozenDescription': npcsDB[int(body[0])]['frozenDescription'], 'affinity': npcsDB[int(body[0])]['affinity'], 'familiar': npcsDB[int(body[0])]['familiar'], 'familiarOf': npcsDB[int(body[0])]['familiarOf'], 'familiarType': npcsDB[int(body[0])]['familiarType'], 'familiarMode': npcsDB[int(body[0])]['familiarMode'], 'animalType': npcsDB[int(body[0])]['animalType']}
