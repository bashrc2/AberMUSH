...
def initialSetupAfterLogin(mud,id,players: {},dbResponse: []):
    ...
    players[id]['clo_lleg'] = dbResponse[31]
    players[id]['clo_rleg'] = dbResponse[32]
    players[id]['clo_feet'] = dbResponse[33]
    players[id]['imp_head'] = dbResponse[34]
    players[id]['imp_larm'] = dbResponse[35]
    players[id]['imp_rarm'] = dbResponse[36]
    players[id]['imp_lhand'] = dbResponse[37]
    players[id]['imp_rhand'] = dbResponse[38]
    players[id]['imp_lfinger'] = dbResponse[39]
    players[id]['imp_rfinger'] = dbResponse[40]
    players[id]['imp_chest'] = dbResponse[41]
    players[id]['imp_lleg'] = dbResponse[42]
    players[id]['imp_rleg'] = dbResponse[43]
    players[id]['imp_feet'] = dbResponse[44]
    players[id]['hpMax'] = dbResponse[45]
    players[id]['hp'] = dbResponse[46]
    players[id]['charge'] = dbResponse[47]
    players[id]['inDescription'] = dbResponse[48]
    players[id]['outDescription'] = dbResponse[49]
    players[id]['lookDescription'] = dbResponse[50]
    ...
    players[id]['channels'] = dbResponse[51]
    players[id]['permissionLevel'] = dbResponse[52]
    players[id]['exAttribute0'] = dbResponse[53]
    players[id]['exAttribute1'] = dbResponse[54]
    players[id]['exAttribute2'] = dbResponse[55]
    players[id]['canGo'] = dbResponse[56]
    players[id]['canLook'] = dbResponse[57]
    players[id]['canSay'] = dbResponse[58]
    players[id]['canAttack'] = dbResponse[59]
    players[id]['canDirectMessage'] = dbResponse[60]
    players[id]['ref'] = dbResponse[61]
    players[id]['bodyType'] = dbResponse[62]
    players[id]['race'] = dbResponse[63]
    players[id]['characterClass'] = dbResponse[64]
    players[id]['proficiencies'] = dbResponse[65]
    players[id]['fightingStyle'] = dbResponse[66]
    players[id]['restRequired'] = dbResponse[67]
    players[id]['enemy'] = dbResponse[68]
    players[id]['tempCharm'] = dbResponse[69]
    players[id]['tempCharmTarget'] = dbResponse[70]
    players[id]['tempCharmDuration'] = dbResponse[71]
    players[id]['tempCharmStart'] = dbResponse[72]
    players[id]['guild'] = dbResponse[73]
    players[id]['guildRole'] = dbResponse[74]
    players[id]['archetype'] = dbResponse[75]
    players[id]['preparedSpells'] = dbResponse[76]
    players[id]['spellSlots'] = dbResponse[77]
    players[id]['tempHitPoints'] = dbResponse[78]
    players[id]['tempHitPointsStart'] = dbResponse[79]
    players[id]['tempHitPointsDuration'] = dbResponse[80]
    players[id]['prepareSpell'] = dbResponse[81]
    players[id]['prepareSpellProgress'] = dbResponse[82]
    players[id]['prepareSpellTime'] = dbResponse[83]
    players[id]['frozenDescription'] = dbResponse[84]
    players[id]['frozenStart'] = dbResponse[85]
    players[id]['frozenDuration'] = dbResponse[86]
    players[id]['affinity'] = dbResponse[87]
    players[id]['familiar'] = dbResponse[88]
    if players[id].get('visibleWhenWearing'):
        players[id]['visibleWhenWearing'] = dbResponse[89]
