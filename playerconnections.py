...
def initialSetupAfterLogin(mud, id, players: {}, dbResponse: []):
    ...
    players[id]['imp_neck'] = dbResponse[36]
    players[id]['imp_larm'] = dbResponse[37]
    players[id]['imp_rarm'] = dbResponse[38]
    players[id]['imp_lhand'] = dbResponse[39]
    players[id]['imp_rhand'] = dbResponse[40]
    players[id]['imp_lfinger'] = dbResponse[41]
    players[id]['imp_rfinger'] = dbResponse[42]
    players[id]['imp_chest'] = dbResponse[43]
    players[id]['imp_back'] = dbResponse[44]
    players[id]['imp_lleg'] = dbResponse[45]
    players[id]['imp_rleg'] = dbResponse[46]
    players[id]['imp_feet'] = dbResponse[47]
    players[id]['hpMax'] = dbResponse[48]
    players[id]['hp'] = dbResponse[49]
    players[id]['charge'] = dbResponse[50]
    players[id]['inDescription'] = dbResponse[51]
    players[id]['outDescription'] = dbResponse[52]
    players[id]['lookDescription'] = dbResponse[53]
    ...
    players[id]['channels'] = dbResponse[54]
    players[id]['permissionLevel'] = dbResponse[55]
    players[id]['exAttribute0'] = dbResponse[56]
    players[id]['exAttribute1'] = dbResponse[57]
    players[id]['exAttribute2'] = dbResponse[58]
    players[id]['canGo'] = dbResponse[59]
    players[id]['canLook'] = dbResponse[60]
    players[id]['canSay'] = dbResponse[61]
    players[id]['canAttack'] = dbResponse[62]
    players[id]['canDirectMessage'] = dbResponse[63]
    players[id]['ref'] = dbResponse[64]
    players[id]['bodyType'] = dbResponse[65]
    players[id]['race'] = dbResponse[66]
    players[id]['characterClass'] = dbResponse[67]
    players[id]['proficiencies'] = dbResponse[68]
    players[id]['fightingStyle'] = dbResponse[69]
    players[id]['restRequired'] = dbResponse[70]
    players[id]['enemy'] = dbResponse[71]
    players[id]['tempCharm'] = dbResponse[72]
    players[id]['tempCharmTarget'] = dbResponse[73]
    players[id]['tempCharmDuration'] = dbResponse[74]
    players[id]['tempCharmStart'] = dbResponse[75]
    players[id]['guild'] = dbResponse[76]
    players[id]['guildRole'] = dbResponse[77]
    players[id]['archetype'] = dbResponse[78]
    players[id]['preparedSpells'] = dbResponse[79]
    players[id]['spellSlots'] = dbResponse[80]
    players[id]['tempHitPoints'] = dbResponse[81]
    players[id]['tempHitPointsStart'] = dbResponse[82]
    players[id]['tempHitPointsDuration'] = dbResponse[83]
    players[id]['prepareSpell'] = dbResponse[84]
    players[id]['prepareSpellProgress'] = dbResponse[85]
    players[id]['prepareSpellTime'] = dbResponse[86]
    players[id]['frozenDescription'] = dbResponse[87]
    players[id]['frozenStart'] = dbResponse[88]
    players[id]['frozenDuration'] = dbResponse[89]
    players[id]['affinity'] = dbResponse[90]
    players[id]['familiar'] = dbResponse[91]
    if players[id].get('visibleWhenWearing'):
        players[id]['visibleWhenWearing'] = dbResponse[92]
