                        ...
                        if players[fights[fid]['s1id']]['room'] == players[fights[fid]['s2id']]['room']:
                                if int(time.time()) >= players[fights[fid]['s1id']]['lastCombatAction'] + 10 - players[fights[fid]['s1id']]['agi']:
                                        if players[fights[fid]['s2id']]['isAttackable'] == 1:
                                                ...
                                                mud.send_message(fights[fid]['s1id'], '<f225>Suddenly you stop. It wouldn`t be a good idea to attack <f32>' + players[fights[fid]['s2id']]['name'] + ' at this time.\n')
                                                fightsCopy = deepcopy(fights)
                                                for (fight, pl) in fightsCopy.items():
                     ...
                     and players[id]['authenticated'] is None:
                        ...
                        if verify_password(dbPass, command):
                                if playerFound == False:
                                        ...
                                        players[id]['clo_neck'] = dbResponse[17]
                                        players[id]['clo_larm'] = dbResponse[18]
                                        players[id]['clo_rarm'] = dbResponse[19]
                                        players[id]['clo_lhand'] = dbResponse[20]
                                        players[id]['clo_rhand'] = dbResponse[21]
                                        players[id]['clo_lwrist'] = dbResponse[22]
                                        players[id]['clo_rwrist'] = dbResponse[23]
                                        players[id]['clo_chest'] = dbResponse[24]
                                        players[id]['clo_lleg'] = dbResponse[25]
                                        players[id]['clo_rleg'] = dbResponse[26]
                                        players[id]['clo_feet'] = dbResponse[27]
                                        players[id]['imp_head'] = dbResponse[28]
                                        players[id]['imp_larm'] = dbResponse[29]
                                        players[id]['imp_rarm'] = dbResponse[30]
                                        players[id]['imp_lhand'] = dbResponse[31]
                                        players[id]['imp_rhand'] = dbResponse[32]
                                        players[id]['imp_chest'] = dbResponse[33]
                                        players[id]['imp_lleg'] = dbResponse[34]
                                        players[id]['imp_rleg'] = dbResponse[35]
                                        players[id]['imp_feet'] = dbResponse[36]
                                        players[id]['hp'] = dbResponse[37]
                                        players[id]['charge'] = dbResponse[38]
                                        players[id]['inDescription'] = dbResponse[39]
                                        players[id]['outDescription'] = dbResponse[40]
                                        players[id]['lookDescription'] = dbResponse[41]
                                        ...
                                        players[id]['idleStart'] = int(time.time())
                                        players[id]['channels'] = dbResponse[42]
                                        players[id]['permissionLevel'] = dbResponse[43]
                                        players[id]['exAttribute0'] = dbResponse[44]
                                        players[id]['exAttribute1'] = dbResponse[45]
                                        players[id]['exAttribute2'] = dbResponse[46]
