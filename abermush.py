                     ...
                     and players[id]['authenticated'] is None:
                        ...
                        if verify_password(dbPass, command):
                                if playerFound == False:
                                        ...
                                        players[id]['clo_head'] = dbResponse[18]
                                        players[id]['clo_neck'] = dbResponse[19]
                                        players[id]['clo_larm'] = dbResponse[20]
                                        players[id]['clo_rarm'] = dbResponse[21]
                                        players[id]['clo_lhand'] = dbResponse[22]
                                        players[id]['clo_rhand'] = dbResponse[23]
                                        players[id]['clo_lwrist'] = dbResponse[24]
                                        players[id]['clo_rwrist'] = dbResponse[25]
                                        players[id]['clo_chest'] = dbResponse[26]
                                        players[id]['clo_lleg'] = dbResponse[27]
                                        players[id]['clo_rleg'] = dbResponse[28]
                                        players[id]['clo_feet'] = dbResponse[29]
                                        players[id]['imp_head'] = dbResponse[30]
                                        players[id]['imp_larm'] = dbResponse[31]
                                        players[id]['imp_rarm'] = dbResponse[32]
                                        players[id]['imp_lhand'] = dbResponse[33]
                                        players[id]['imp_rhand'] = dbResponse[34]
                                        players[id]['imp_chest'] = dbResponse[35]
                                        players[id]['imp_lleg'] = dbResponse[36]
                                        players[id]['imp_rleg'] = dbResponse[37]
                                        players[id]['imp_feet'] = dbResponse[38]
                                        players[id]['hp'] = dbResponse[39]
                                        players[id]['charge'] = dbResponse[40]
                                        players[id]['inDescription'] = dbResponse[41]
                                        players[id]['outDescription'] = dbResponse[42]
                                        players[id]['lookDescription'] = dbResponse[43]
                                        players[id]['isInCombat'] = 0
                                        players[id]['lastCombatAction'] = int(time.time())
                                        players[id]['isAttackable'] = 1
                                        players[id]['corpseTTL'] = 60
                                        players[id]['idleStart'] = int(time.time())
                                        players[id]['channels'] = dbResponse[44]
                                        players[id]['permissionLevel'] = dbResponse[45]
                                        players[id]['exAttribute0'] = dbResponse[46]
                                        players[id]['exAttribute1'] = dbResponse[47]
                                        players[id]['exAttribute2'] = dbResponse[48]
                                        players[id]['canGo'] = dbResponse[49]
                                        players[id]['canLook'] = dbResponse[50]
                                        players[id]['canSay'] = dbResponse[51]
                                        players[id]['canAttack'] = dbResponse[52]
                                        players[id]['canDirectMessage'] = dbResponse[53]
                                        players[id]['ref'] = dbResponse[54]
                                        players[id]['bodyType'] = dbResponse[55]
                                        players[id]['race'] = dbResponse[56]
                                        players[id]['characterClass'] = dbResponse[57]
