        ...
        for (id, command, params) in mud.get_commands():
                ...
                if players[id]['name'] is None and players[id]['exAttribute0'] == None:
                     ...
                     and players[id]['authenticated'] is None:
                        ...
                        if players[id]['exAttribute0'] < 1000:
                                if len(command) > 0:
                                        runCommand(command.lower(), params, mud, playersDB, players, rooms, npcsDB, npcs, itemsDB, itemsInWorld, envDB, env, scriptedEventsDB, eventSchedule, id, fights, corpses, blocklist, mapArea, characterClassDB, spellsDB, sentimentDB)
