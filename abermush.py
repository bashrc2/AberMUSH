                     ...
                     and players[id]['authenticated'] is None:
                        ...
                        if verify_password(dbPass, command):
                                if playerFound == False:
                                        ...
                                        players[id]['hp'] = dbResponse[41]
                                        players[id]['charge'] = dbResponse[42]
                                        players[id]['inDescription'] = dbResponse[43]
                                        players[id]['outDescription'] = dbResponse[44]
                                        players[id]['lookDescription'] = dbResponse[45]
                                        players[id]['isInCombat'] = 0
                                        players[id]['lastCombatAction'] = int(time.time())
                                        players[id]['isAttackable'] = 1
                                        players[id]['corpseTTL'] = 60
                                        players[id]['idleStart'] = int(time.time())
                                        players[id]['channels'] = dbResponse[46]
                                        players[id]['permissionLevel'] = dbResponse[47]
                                        players[id]['exAttribute0'] = dbResponse[48]
                                        players[id]['exAttribute1'] = dbResponse[49]
                                        players[id]['exAttribute2'] = dbResponse[50]
                                        players[id]['canGo'] = dbResponse[51]
                                        players[id]['canLook'] = dbResponse[52]
                                        players[id]['canSay'] = dbResponse[53]
                                        players[id]['canAttack'] = dbResponse[54]
                                        players[id]['canDirectMessage'] = dbResponse[55]
                                        players[id]['ref'] = dbResponse[56]
                                        ...
                                        players[id]['fightingStyle'] = dbResponse[61]
                                        players[id]['restRequired'] = dbResponse[62]
                                        players[id]['enemy'] = dbResponse[63]
                                        players[id]['archetype'] = dbResponse[64]
